      ...
      return { 
         ...
         loadDefaults : function() {
            ...
            if(isNumeric($.a.width)) {
               $.a.innerWidth = ($.a.width - 5) + '%'; $.a.width += '%';
            } else {
               $.a.innerWidth = 'auto';
            }
         ...
         buildPresentation : function () {
            ...
            var rules = {
               "" : "{margin:0px;padding:0px;width:" + $.a.width + ";background:" + $.a.background + ";" + ";font:87%/1.2em tahoma, veranda, arial, helvetica, clean, sans-serif;}",
               ...
               "p a" : "{color:#C15D42;}",
               "ul":"{margin:0px; padding:0px; height:" + $.a.height + ";width:" + $.a.innerWidth + ";overflow:hidden;}",
